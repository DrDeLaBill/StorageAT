...
{
public:
    virtual StorageStatus read(const uint32_t, uint8_t*, const uint32_t)             = 0;
    virtual StorageStatus write(const uint32_t, const uint8_t*, const uint32_t)      = 0;
    virtual StorageStatus erase(const uint32_t*, const uint32_t)                     = 0;
    
    virtual StorageStatus asyncRead(const uint32_t, uint8_t*, const uint32_t)        = 0;
    virtual StorageStatus asyncWrite(const uint32_t, const uint8_t*, const uint32_t) = 0;
    virtual StorageStatus asyncErase(const uint32_t*, const uint32_t)                = 0;
};
...
public:
    ...
    /*
     * Storage asynchronous process
     */
    void tick();

    /*
     * Storage asynchronous callback
     *
     * @param status Asynchronous response status
     */
     ...
     * @param mode     Current search mode
     * @param address  Pointer that used to find needed page address
     * @param callback Result callback function pointer
     * @param prefix   String page prefix of header that needed to be found in storage
     * @param id       Integer page prefix of header that needed to be found in storage
     * @return         Returns STORAGE_OK if the request was initiated
     */
    ...
    /*
     * Load data from the storage address
     *
    ...
    /*
     * Asynchronous load data from the storage address
     *
     * @param address  Storage page address to load
     * @param data     Pointer to data array for load data
     * @param len      Data array length
     ...
     * @return         Returns STORAGE_OK if the request was initiated
     */
    StorageStatus asyncLoad(uint32_t address, uint8_t* data, uint32_t len, callback_t callback);
    ...
    /*
     * Asynchronous save the data to storage address
     *
     * @param address  Storage page address to save
     * @param prefix   String page prefix of header
     * @param id       Integer page prefix of header
    ...
    /*
     * Asynchronous rewrite the data contained in storage address
     *
     * @param address  Storage page address to save
     * @param prefix   String page prefix of header
     * @param id       Integer page prefix of header
